...
public class HomePage extends javax.swing.JFrame implements WritableGUI{
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Group Mates");

        jList2.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        jList2.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Group Mate 1", "Group Mate 2", "Group Mate 3" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addComponent(refresh, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28))))
        );
        ...
        try {
            ...
            if(!is_Group)
            {
                ...
                if(s.nextLine().equals("Ok"))
                {
                    ...
                    host = s.nextLine();
                    Sender transmitter = new Sender(this.Username+": "+msg.getText(), host,sending_port,Username);
                    transmitter.start();
            ...
            else
            {
                ...
                if(s.nextLine().equals("Ok"))
                {
                    ...
                    for (int i = 0; i < fin.size(); i++) {
                        ...
                        Sender transmitter = new Sender("Group_"+this.Username+": "+msg.getText(),"0.0.0.0",sending_port,this.Username);
                        transmitter.start();
                    }
                    chat.append("Group_Me: "+msg.getText()+"\n");
                }
           }
            sock.close();
        } catch (IOException ex) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            p.flush();
            is_Group = true; 
            JOptionPane.showMessageDialog(null, "Connected to Group chat!");
            sock.close();
        } catch (IOException ex) {
            Logger.getLogger(HomePage.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            p.flush();
            is_Group = false;
            JOptionPane.showMessageDialog(null, "Disconnected from Group chat!");
            sock.close();
        } catch (IOException ex) {
            Logger.getLogger(HomePage.class.getName()).log(Level.SEVERE, null, ex);
        }
